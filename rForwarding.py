...
###############################################################################
#        ___________                                    .___.__               #  
#______\_   _____/____________  _  _______ _______  __| _/|__| ____    ____   #
#\_  __ \    __)/  _ \_  __ \ \/ \/ /\__  \\_  __ \/ __ | |  |/    \  / ___\  #
# |  | \/     \(  <_> )  | \/\     /  / __ \|  | \/ /_/ | |  |   |  \/ /_/  > #
# |__|  \___  / \____/|__|    \/\_/  (____  /__|  \____ | |__|___|  /\___  /  #
#           \/                            \/           \/         \//_____/   #
#                                                                             #
###############################################################################
...
# Requires paramiko: http://www.paramiko.org/
    ...
    # openssl required as well

"""

Used to forward internal resources out of an ssh tunnel to a receiving external ssh server
InternalResource > sshClient > sshServer
...
# Example Syntax:
# C:\tmp>rforward.py 192.168.100.133 -p 8080 -r 192.168.100.128:80
# client script ...   server socket   ...   bind to remote socket
